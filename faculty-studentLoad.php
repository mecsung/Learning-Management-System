...
<html lang="en" dir="ltr">
    <head>
		...
		<!-- CUSTOM STYLESHEET -->
        <link rel="stylesheet" href="styles/student-facultyLoad-style.css">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="content">
				<div class="directory">
					<p>Faculty Module / Faculty Loads / Enrolled Students</p>
				</div>
				<h3>Instructor's Students</h3>
				<hr></hr>
				
                <form action="faculty-studentLoad.php" method="POST">
                    
                <?php
				$course_name = $_GET['id'];
				
				error_reporting(E_ERROR | E_PARSE);
				$res = mysqli_query ($connection, "SELECT * FROM course_enrolled WHERE ccourse='$course_name'");
				while ($row = mysqli_fetch_array($res))
				{ ?>
					<td> <?php echo $row["program_class"]; ?> </td>
				<?php }
			    ?>
